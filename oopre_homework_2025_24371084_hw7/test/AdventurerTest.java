...
//        testUser.takeItem("Bot2"); not take
    ...
    public void loadRelation() {
        ...
        Adventurer Engel = new Adventurer("Engel");
        Adventurer George = new Adventurer("George");
        Adventurer Howard = new Adventurer("Howard");
        advs.add(Alice);
        advs.add(Bob);
        advs.add(Carol);
        advs.add(Fish);
        ...
        cmd.add("lr");
        cmd.add("Alice(Bob(Carol, Dave(Howard)),  Engel(Fish),George)");
        Factory.loadRelation(advs, cmd);
